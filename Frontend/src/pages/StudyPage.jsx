...
const API_URL = "https://breakitdown-ruby.vercel.app/api/data";
const SAVE_CARD_URL = "https://breakitdown-ruby.vercel.app/api/user/card";
const INCREASE_CARDS_STUDIED_URL = "https://breakitdown-ruby.vercel.app/api/increase-cards-studied";
const SAVE_HISTORY_URL = "https://breakitdown-ruby.vercel.app/api/user/history-save";
  ...
  const handleAddToAnki = async () => {
    ...
    try {
      ...
      if (!back.trim()) {
        ...
        const genResponse = await fetch("https://breakitdown-ruby.vercel.app/api/generate-back", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      // 🔹 Send to Anki
      const response = await fetch("https://breakitdown-ruby.vercel.app/api/anki/add", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
